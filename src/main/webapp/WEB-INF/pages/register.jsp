                    ...
                    <div class="container">
                        <div class="row 4">
                            <div class="col-sm-8 col-sm-offset-2">
                                <h1><strong>Helperk</strong> Registration</h1>
                            </div>
                        </div>
                                    ...
                                    <form role="form" action="/register" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="${user.email}" name="email" placeholder="Email..."
                                                   class="form-last-name form-control" id="form-password">
                                        </div>
                                        <div class="form-group">
                                            <label class="sr-only" for="form-email">Email</label>
                                            <input type="password" name="password" placeholder="Password..."
                                                   class="form-last-name form-control" id="form-email">
                                        </div>
                                        <button type="submit" class="btn btn-default btn-xl">Register</button>
                                        <button type="button" onclick="window.location.href='/login/'"
                                                class="btn btn-default btn-xl">Login
                                        </button>
                                    </form>

!function (a, b) {
    ...
    function da(a) {
        var b, c, d, e, f, g, h = a._i, i = Be.exec(h) || Ce.exec(h);
        if (i) {
            for (j(a).iso = !0, b = 0, c = Ee.length; c > b; b++)if (Ee[b][1].exec(i[1])) {
                e = Ee[b][0], d = Ee[b][2] !== !1;
                break
            }
            if (null == e)return void(a._isValid = !1);
            if (i[3]) {
                for (b = 0, c = Fe.length; c > b; b++)if (Fe[b][1].exec(i[3])) {
                    f = (i[2] || " ") + Fe[b][0];
                    break
                }
    ...
    function Ha(a, b) {
        var c = (b || "").match(a) || [], d = c[c.length - 1] || [], e = (d + "").match(Le) || ["-", 0, 0], f = +(60 * e[1]) + r(e[2]);
        return "+" === e[0] ? f : -f
    }
    ...
    function Mc(a, b, c) {
        var d = Va(a).abs(), e = Af(d.as("s")), f = Af(d.as("m")), g = Af(d.as("h")), h = Af(d.as("d")), i = Af(d.as("M")), j = Af(d.as("y")), k = e < Bf.s && ["s", e] || 1 >= f && ["m"] || f < Bf.m && ["mm", f] || 1 >= g && ["h"] || g < Bf.h && ["hh", g] || 1 >= h && ["d"] || h < Bf.d && ["dd", h] || 1 >= i && ["M"] || i < Bf.M && ["MM", i] || 1 >= j && ["y"] || ["yy", j];
...
//! Author : Menelion Elensúle : https://github.com/Oire
    ...
    var xe = /D[oD]?(\[[^\[\]]*\]|\s+)+MMMM?/, ye = "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ze = "Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sept_Oct_Nov_Dec".split("_"), Ae = {};
    a.suppressDeprecationWarnings = !1;
    var Be = /^\s*((?:[+-]\d{6}|\d{4})-(?:\d\d-\d\d|W\d\d-\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?::\d\d(?::\d\d(?:[.,]\d+)?)?)?)([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?/, Ce = /^\s*((?:[+-]\d{6}|\d{4})(?:\d\d\d\d|W\d\d\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?:\d\d(?:\d\d(?:[.,]\d+)?)?)?)([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?/, De = /Z|[+-]\d\d(?::?\d\d)?/, Ee = [["YYYYYY-MM-DD", /[+-]\d{6}-\d\d-\d\d/], ["YYYY-MM-DD", /\d{4}-\d\d-\d\d/], ["GGGG-[W]WW-E", /\d{4}-W\d\d-\d/], ["GGGG-[W]WW", /\d{4}-W\d\d/, !1], ["YYYY-DDD", /\d{4}-\d{3}/], ["YYYY-MM", /\d{4}-\d\d/, !1], ["YYYYYYMMDD", /[+-]\d{10}/], ["YYYYMMDD", /\d{8}/], ["GGGG[W]WWE", /\d{4}W\d{3}/], ["GGGG[W]WW", /\d{4}W\d{2}/, !1], ["YYYYDDD", /\d{7}/]], Fe = [["HH:mm:ss.SSSS", /\d\d:\d\d:\d\d\.\d+/], ["HH:mm:ss,SSSS", /\d\d:\d\d:\d\d,\d+/], ["HH:mm:ss", /\d\d:\d\d:\d\d/], ["HH:mm", /\d\d:\d\d/], ["HHmmss.SSSS", /\d\d\d\d\d\d\.\d+/], ["HHmmss,SSSS", /\d\d\d\d\d\d,\d+/], ["HHmmss", /\d\d\d\d\d\d/], ["HHmm", /\d\d\d\d/], ["HH", /\d\d/]], Ge = /^\/?Date\((\-?\d+)/i;
    ...
    var Me = /(\-)?(?:(\d*)[. ])?(\d+)\:(\d+)(?:\:(\d+)\.?(\d{3})?)?/, Ne = /^(-)?P(?:(?:([0-9,.]*)Y)?(?:([0-9,.]*)M)?(?:([0-9,.]*)D)?(?:T(?:([0-9,.]*)H)?(?:([0-9,.]*)M)?(?:([0-9,.]*)S)?)?|([0-9,.]*)W)$/;
    Va.fn = Ea.prototype;
    var Oe = Za(1, "add"), Pe = Za(-1, "subtract");
    ...
    var Te = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), Ue = "Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"), Ve = "Su_Mo_Tu_We_Th_Fr_Sa".split("_");
    ...
    var kf = Math.abs, lf = Hc("ms"), mf = Hc("s"), nf = Hc("m"), of = Hc("h"), pf = Hc("d"), qf = Hc("w"), rf = Hc("M"), sf = Hc("y"), tf = Jc("milliseconds"), uf = Jc("seconds"), vf = Jc("minutes"), wf = Jc("hours"), xf = Jc("days"), yf = Jc("months"), zf = Jc("years"), Af = Math.round, Bf = {
        s: 45,
        m: 45,
        h: 22,
        d: 26,
        M: 11
    }, Cf = Math.abs, Df = Ea.prototype;
...
//! momentjs.com
    ...
    var Ef = a, Ff = (Ef.defineLocale("af", {
        ...
        week: {dow: 6, doy: 12}
    }), {1: "١", 2: "٢", 3: "٣", 4: "٤", 5: "٥", 6: "٦", 7: "٧", 8: "٨", 9: "٩", 0: "٠"}), Gf = {
        "١": "1",
        "٢": "2",
        "٣": "3",
        "٤": "4",
        ...
        week: {dow: 1, doy: 4}
    }), {1: "١", 2: "٢", 3: "٣", 4: "٤", 5: "٥", 6: "٦", 7: "٧", 8: "٨", 9: "٩", 0: "٠"}), If = {
        "١": "1",
        "٢": "2",
        "٣": "3",
        "٤": "4",
        ...
        return function (b, c, d, e) {
            var f = Jf(b), g = Kf[a][Jf(b)];
            return 2 === f && (g = g[c ? 0 : 1]), g.replace(/%d/i, b)
        }
    }, Mf = ["كانون الثاني يناير", "شباط فبراير", "آذار مارس", "نيسان أبريل", "أيار مايو", "حزيران يونيو", "تموز يوليو", "آب أغسطس", "أيلول سبتمبر", "تشرين الأول أكتوبر", "تشرين الثاني نوفمبر", "كانون الأول ديسمبر"], Nf = (Ef.defineLocale("ar", {
        months: Mf,
        monthsShort: Mf,
        weekdays: "الأحد_الإثنين_الثلاثاء_الأربعاء_الخميس_الجمعة_السبت".split("_"),
        weekdaysShort: "أحد_إثنين_ثلاثاء_أربعاء_خميس_جمعة_سبت".split("_"),
        ...
        week: {dow: 1, doy: 7}
    }), {1: "১", 2: "২", 3: "৩", 4: "৪", 5: "৫", 6: "৬", 7: "৭", 8: "৮", 9: "৯", 0: "০"}), Pf = {
        "১": "1",
        "২": "2",
        "৩": "3",
        "৪": "4",
        ...
        week: {dow: 0, doy: 6}
    }), {1: "༡", 2: "༢", 3: "༣", 4: "༤", 5: "༥", 6: "༦", 7: "༧", 8: "༨", 9: "༩", 0: "༠"}), Rf = {
        "༡": "1",
        "༢": "2",
        "༣": "3",
        "༤": "4",
        ...
        week: {dow: 1, doy: 4}
    }), "leden_únor_březen_duben_květen_červen_červenec_srpen_září_říjen_listopad_prosinec".split("_")), Tf = "led_úno_bře_dub_kvě_čvn_čvc_srp_zář_říj_lis_pro".split("_"), Uf = (Ef.defineLocale("cs", {
        months: Sf,
        monthsShort: Tf,
        ...
        ordinal: "%d.",
        week: {dow: 1, doy: 4}
    }), ["ޖެނުއަރީ", "ފެބްރުއަރީ", "މާރިޗު", "އޭޕްރީލު", "މޭ", "ޖޫން", "ޖުލައި", "އޯގަސްޓު", "ސެޕްޓެމްބަރު", "އޮކްޓޯބަރު", "ނޮވެމްބަރު", "ޑިސެމްބަރު"]), Vf = ["އާދިއްތަ", "ހޯމަ", "އަންގާރަ", "ބުދަ", "ބުރާސްފަތި", "ހުކުރު", "ހޮނިހިރު"], Wf = (Ef.defineLocale("dv", {
        months: Uf,
        monthsShort: Uf,
        weekdays: Vf,
        weekdaysShort: Vf,
        ...
        ordinal: "%da",
        week: {dow: 1, doy: 7}
    }), "ene._feb._mar._abr._may._jun._jul._ago._sep._oct._nov._dic.".split("_")), Xf = "ene_feb_mar_abr_may_jun_jul_ago_sep_oct_nov_dic".split("_"), Yf = (Ef.defineLocale("es", {
        ...
        ordinal: "%d.",
        week: {dow: 1, doy: 7}
    }), {1: "۱", 2: "۲", 3: "۳", 4: "۴", 5: "۵", 6: "۶", 7: "۷", 8: "۸", 9: "۹", 0: "۰"}), Zf = {
        "۱": "1",
        "۲": "2",
        "۳": "3",
        "۴": "4",
        ...
        ordinal: "%dم",
        week: {dow: 6, doy: 12}
    }), "nolla yksi kaksi kolme neljä viisi kuusi seitsemän kahdeksan yhdeksän".split(" ")), _f = ["nolla", "yhden", "kahden", "kolmen", "neljän", "viiden", "kuuden", $f[7], $f[8], $f[9]], ag = (Ef.defineLocale("fi", {
        ...
        week: {dow: 1, doy: 4}
    }), "jan._feb._mrt._apr._mai_jun._jul._aug._sep._okt._nov._des.".split("_")), bg = "jan_feb_mrt_apr_mai_jun_jul_aug_sep_okt_nov_des".split("_"), cg = (Ef.defineLocale("fy", {
    ...
    }), {1: "१", 2: "२", 3: "३", 4: "४", 5: "५", 6: "६", 7: "७", 8: "८", 9: "९", 0: "०"}), ig = {
        "१": "1",
        "२": "2",
        "३": "3",
        "४": "4",
        ...
        ordinal: "%d.",
        week: {dow: 1, doy: 7}
    }), "vasárnap hétfőn kedden szerdán csütörtökön pénteken szombaton".split(" ")), kg = (Ef.defineLocale("hu", {
        ...
        week: {dow: 0, doy: 6}
    }), "jan._feb._mrt._apr._mei_jun._jul._aug._sep._okt._nov._dec.".split("_")), vg = "jan_feb_mrt_apr_mei_jun_jul_aug_sep_okt_nov_dec".split("_"), wg = (Ef.defineLocale("nl", {
        ...
        ordinal: "%d.",
        week: {dow: 1, doy: 4}
    }), "styczeń_luty_marzec_kwiecień_maj_czerwiec_lipiec_sierpień_wrzesień_październik_listopad_grudzień".split("_")), xg = "stycznia_lutego_marca_kwietnia_maja_czerwca_lipca_sierpnia_września_października_listopada_grudnia".split("_"), yg = (Ef.defineLocale("pl", {
        months: function (a, b) {
        ...
        week: {dow: 1, doy: 7}
    }), [/^янв/i, /^фев/i, /^мар/i, /^апр/i, /^ма[й|я]/i, /^июн/i, /^июл/i, /^авг/i, /^сен/i, /^окт/i, /^ноя/i, /^дек/i]), zg = (Ef.defineLocale("ru", {
        months: {
    ...
    }), "január_február_marec_apríl_máj_jún_júl_august_september_október_november_december".split("_")), Ag = "jan_feb_mar_apr_máj_jún_júl_aug_sep_okt_nov_dec".split("_"), Bg = (Ef.defineLocale("sk", {
        months: zg,
        monthsShort: Ag,
        ...
        week: {dow: 1, doy: 7}
    }), {1: "௧", 2: "௨", 3: "௩", 4: "௪", 5: "௫", 6: "௬", 7: "௭", 8: "௮", 9: "௯", 0: "௦"}), Eg = {
        "௧": "1",
        "௨": "2",
        "௩": "3",
        "௪": "4",
        ...
        week: {dow: 1, doy: 4}
    }), "pagh_wa’_cha’_wej_loS_vagh_jav_Soch_chorgh_Hut".split("_")), Gg = (Ef.defineLocale("tlh", {
